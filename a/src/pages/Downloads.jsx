...
import { Download, FileText, Monitor, Smartphone, CheckCircle } from 'lucide-react'
  ...
  const downloads = [
    {
      ...
      platforms: [
        ...
        { name: 'macOS', icon: Monitor, url: '#', size: '52 MB' },
        { name: 'Linux', icon: Monitor, url: '#', size: '38 MB' }
      ],
      features: [
        'Offline processing',
    ...
    },
    {
      ...
      platforms: [
        { name: 'Android', icon: Smartphone, url: '#', size: '28 MB' },
        { name: 'iOS', icon: Smartphone, url: '#', size: '32 MB' }
      ],
      features: [
        'Camera OCR scanning',
        'Quick conversion',
